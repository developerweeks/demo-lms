...
class ComposerAutoloaderInit1126f2a1d20d4b0a19d60d62b0198ab5
{
    ...
    public static function getLoader()
    {
        ...
        call_user_func(\Composer\Autoload\ComposerStaticInit1126f2a1d20d4b0a19d60d62b0198ab5::getInitializer($loader));

        $loader->register(true);

        $filesToLoad = \Composer\Autoload\ComposerStaticInit1126f2a1d20d4b0a19d60d62b0198ab5::$files;
